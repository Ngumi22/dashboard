...
`);
    ...
    await connection.query(`
      CREATE TABLE IF NOT EXISTS product_variant_images (
          ...
          variant_image MEDIUMBLOB NOT NULL,
          variant_thumbnail1 MEDIUMBLOB NOT NULL,
          variant_thumbnail2 MEDIUMBLOB NOT NULL,
          variant_thumbnail3 MEDIUMBLOB NOT NULL,
          variant_thumbnail4 MEDIUMBLOB NOT NULL,
          variant_thumbnail5 MEDIUMBLOB NOT NULL,
          created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
          updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
          deleted_at TIMESTAMP NULL,
          created_by INT,
