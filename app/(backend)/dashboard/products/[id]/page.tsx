      ...
      <section className="container flex-grow mx-auto max-w-[1200px] border-b py-5 lg:grid lg:grid-cols-2 lg:py-10">
        ...
        <div className="mx-auto px-5 lg:px-5">
          ...
          <div className="mt-7 flex flex-row items-center gap-6">
            <button className="flex py-3 px-8 items-center justify-center bg-violet-900 text-white duration-100 hover:bg-blue-800">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
            ...
            <button className="flex py-3 px-8 items-center justify-center bg-amber-400 duration-100 hover:bg-yellow-300">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
