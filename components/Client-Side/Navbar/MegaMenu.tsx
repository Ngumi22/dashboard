  ...
  return (
    <section className="hidden bg-[#232F3E] md:grid grid-flow-col">
      <div className="justify-self-start relative group ">
        <Button
          variant="ghost"
          className="group text-white gap-x-4 uppercase text-xs md:text-md rounded-none">
      ...
      <div className="grid grid-flow-col justify-self-start md:gap-x-6">
        <Button
          variant="link"
          className="text-white uppercase text-xs md:text-md rounded-none">
          <Link href={"/"}>Home</Link>
        </Button>
        <div
          className="relative"
          ...
          <Button
            variant="ghost"
            className="text-white hover:text-black uppercase text-xs md:text-md rounded-none">
            <span>Our Store</span>
        ...
        <div
          ...
          {activeMenu === "elements" && (
            <div className="absolute right-0 left-0 top-full w-36 bg-white shadow-md overflow-hidden z-50">
              {elements.map((item) => (
                <Button
                  key={item}
                  variant="ghost"
