      ...
      <div className="relative h-full p-8 md:p-12 z-10">
        ...
        <div className="flex flex-col justify-center w-full md:w-1/2 h-full">
          <div
            ...
            <h1 className="text-white text-3xl md:text-4xl lg:text-5xl font-bold mb-4 tracking-tight">
            ...
            <div className="flex flex-col md:flex-row items-start gap-4">
              <Link
                href={carousel.link}
                className="bg-red-600 hover:bg-red-700 text-white font-medium px-8 py-2 rounded-md transition-colors">
                Buy Now
              </Link>
            </div>
          </div>
